...
struct qt_meta_stringdata_Displayer_t {
    QByteArrayData data[1];
    char stringdata[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Displayer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Displayer_t qt_meta_stringdata_Displayer = {
    {
...
const QMetaObject Displayer::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Displayer.data,
      qt_meta_data_Displayer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Displayer.stringdata))
